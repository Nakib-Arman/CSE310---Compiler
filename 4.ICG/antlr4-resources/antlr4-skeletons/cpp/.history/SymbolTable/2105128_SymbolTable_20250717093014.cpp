...
public:
    ...
    pair<string,pair<int,int>> insert(string name, string type, string scope, int stack_index, Function* func)
    {
        pair<int,int> inserted = current_scope->insert(name, type, scope, stack_index, func);
    ...
    string getStackIndex(string name)
    {
