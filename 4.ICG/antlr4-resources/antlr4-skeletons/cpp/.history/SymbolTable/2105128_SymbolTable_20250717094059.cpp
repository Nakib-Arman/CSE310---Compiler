...
public:
    ...
    pair<string,pair<int,int>> insert(string name, string type, string scope, Function* func)
    {
    ...
    {
        return current_scope->getVariableScope(name);
    }

    int getStackIndex(string name)
    {
        return current_scope->getStackIndex(name);
    }
};