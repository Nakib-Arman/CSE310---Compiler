...
public:
  ...
  virtual void enterType_specifier_stack(C8086Parser::Type_specifier_stackContext * /*ctx*/) override { }
  virtual void exitType_specifier_stack(C8086Parser::Type_specifier_stackContext * /*ctx*/) override { }
