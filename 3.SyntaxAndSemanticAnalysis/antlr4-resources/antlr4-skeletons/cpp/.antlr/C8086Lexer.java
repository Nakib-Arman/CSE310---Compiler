// Generated from /home/arzon/Work/Academics/3-1/Sessional/CSE210 - Compiler/3.SyntaxAndSemanticAnalysis/antlr4-resources/antlr4-skeletons/cpp/C8086Lexer.g4 by ANTLR 4.13.1
...
public class C8086Lexer extends Lexer {
	...
	private void QMARK_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 27:
			 writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <QMARK> Lexeme " + getText()); 
			break;
		}
	}
