...
FORIN    : 'for' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <FORIN> Lexeme " + getText()); };
FOREACH  : 'in' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <FOREACH> Lexeme " + getText()); };
