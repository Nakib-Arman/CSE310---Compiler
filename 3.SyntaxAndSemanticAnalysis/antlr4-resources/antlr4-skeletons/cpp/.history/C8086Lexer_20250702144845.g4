...
WHEN     : 'when' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <TO> Lexeme " + getText()); };
PRINT    : 'println' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <TO> Lexeme " + getText()); };
