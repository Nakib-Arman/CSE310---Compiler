...
PRINT    : 'println' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <PRINTLN> Lexeme " + getText()); };
ARROW    : 'println' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <PRINTLN> Lexeme " + getText()); };
...
QMARK    : '?' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <QMARK> Lexeme " + getText()); };
