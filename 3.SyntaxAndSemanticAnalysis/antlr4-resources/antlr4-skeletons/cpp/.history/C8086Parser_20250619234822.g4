...
declaration_list returns [string dl_list]
		: declaration_list COMMA ID {
			$dl_list = "Line " + to_string($ID->getLine()) + ": declaration_list : decalration_list COMMA ID\n";
			writeIntoparserLogFile("Line " + to_string($ID->getLine()) + ": declaration_list : declaration_list");
		}
