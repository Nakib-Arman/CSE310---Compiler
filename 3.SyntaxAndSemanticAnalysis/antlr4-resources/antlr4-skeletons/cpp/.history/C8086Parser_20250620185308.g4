...
statement returns [string st_text]
	  ...
	  | FOR LPAREN es1=expression_statement es2=expression_statement ex=expression RPAREN statement {
		$st_text = $FOR->getText() + " " + $LPAREN->getText() + $ex.expr_text + $RPAREN->getText() + $st.st_text;
