...
declaration_list returns [std::string dl_list]
		: declaration_list COMMA ID {
			$dl_list = "Line " + to_string($ID->getLine()) + ": declaration_list : " + $declaration_list.dl_list;
			writeIntoparserLogFile("Line " + to_string($ID->getLine()) + ": declaration_list : ");
		}
 		  | declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
 		  | ID {
			$dl_list = "Line " + to_string($ID->getLine()) + " decleration_list : ID\n";
