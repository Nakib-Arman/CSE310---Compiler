...
declaration_list 
		: dl=declaration_list COMMA ID {
			writeIntoparserLogFile("Line decleration_list : ID\n");
			// writeIntoparserLogFile($dl.getText() + "\n");
		}
 		  | declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
 		  | ID {
			writeIntoparserLogFile("Line " + to_string($dl.stop->getLine()) + "decleration_list : ID\n");
			// writeIntoparserLogFile($dl.getText() + "\n");
		}
